...
<font size="-0.25"> Condition anticipation comparison by group </font>
<img src="./libs/images/tc_group.png" width="1800" height="350">

**T-tests <font size="-0.5"> (Adjusted alpha level = 0.013) </font>**

Mon*Fig target onset p = 0.003      
...
**Main effects:**
- Condition (figurativeness) (Pr(>Chisq) = 0.001)
- Frequency of occurrence (Pr(>Chisq) = 0.002)
...
Interaction of condition and frequency on slope (Pr(>Chisq) = .000)
---
